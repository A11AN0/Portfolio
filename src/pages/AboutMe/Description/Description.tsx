    ...
    <div className="description">
      ...
      <div className="description__text">
        <p className="description__text__paragraph">
          I'm an Australian junior full-stack developer with a passion for
          creating beautiful, intuitive, and responsive user experiences, while
          meeting the functional demands of an application on the serverside.
          <br /> <br />
          Highly driven, adaptable, personable and team-oriented. I strive to
          deliver a polished product for client and corporation alike.
        </p>
        <FontAwesomeIcon
          icon={faChevronDown}
